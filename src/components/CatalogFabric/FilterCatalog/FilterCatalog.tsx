						...
						{filterOptions.map((option: FilterOption) => (
							...
							>
								<input
                                    ...
                                    onChange={() => {
                                        setFilter({...filterValue, type: option.value})
                                    }}
								/>
                                    ...
                                    onChange={e => {
                                        if(e.target.checked) {
                                            setFilter((filterValue: any) => ({
                                                ...filterValue,
                                                availability: [...filterValue.availability, option]
                                            }))
                                        } else{
                                            setFilter((filterValue: any) => ({
                                                ...filterValue,
                                                availability: filterValue.availability.filter((item: string) => item != option)
                                            }))
                                        }
                                    }}
								/>
