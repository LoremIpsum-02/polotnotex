			...
			<div className={styles.catalogFabric} ref={productsRef}>
				...
				{filterOption.type != "all" ? (
					...
					<div className={styles.fabricDescription__container}>
						...
						<div className={styles.fabricDescription__text}>
							Флисовая ткань по оптовым ценам от производителя. В
							текстильном деле широкое распространение получила
							флисовая ткань. Из этого материала шьют повседневную
							и спортивную одежду, текстиль для дома и мебели.
							Производствам как крупного, так и мелкого звеньев
							будет полезно обратить внимание на это сырье. В
							статье пойдет речь о том, что это за материал, какие
							у него плюсы и минусы, его разновидностях. Также
							здесь рассказывается об особенностях обработки
							материала и сфере его применения. <br /> <br />
							Флисовая ткань по оптовым ценам от производителя. В
							текстильном деле широкое распространение получила
							флисовая ткань. Из этого материала шьют повседневную
							и спортивную одежду, текстиль для дома и мебели.
							...
							у него плюсы и минусы, его разновидностях. Также
							здесь рассказывается об особенностях обработки
							материала и сфере его применения.
						</div>
					</div>
				)}
			</div>
