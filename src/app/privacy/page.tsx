	...
	return (
		<>
			<div className={styles.privacyPolicy}>
				...
				Предпринимает их Текстильное Полотно (далее — Оператор). 
				...
				адресу <a href="https://polotnotex.ru/">https://polotnotex.ru</a>. 
				...
				определяемому Пользователю сайта https://polotnotex.ru/. 
				...
				10 дней с даты получения такого запроса; — публиковать или иным
				...
				5.8. Не происходит
				передачи персональных данных при получении
				пользователем промокодов, купонов или иных акций и скидок на
				сторонних ресурсах. 
				...
				6.2. Обработка персональных данных необходима для
				...
				Оператора zakaz@polotnotex.ru с пометкой "Актуализация
				персональных данных". 
				...
				или действующим законодательством. Пользователь может в любой
				...
				электронный адрес Оператора zakaz@polotnotex.ru с пометкой
				"Отзыв согласия на обработку персональных данных". 
				
				7.5. Вся
				информация, которая собирается сторонними сервисами, в том числе
				платежными системами, средствами связи и другими поставщиками
				...
				7.6. Установленные субъектом персональных
				...
				7.7. Оператор при обработке
				персональных данных обеспечивает конфиденциальность персональных
				данных. 
				
				7.8. При осуществлении доставки товаров Оператор может
				собирать данные о конечной точке доставки и получателе, чтобы
				точно рассчитать маршрут. Грузоперевозка осуществляется с
				помощью транспортных компаний и курьерских служб доставки. Цены
				по тарифам перевозчика в зависимости от объёма и массы груза, а
				так же удалённости от точки отправки. 
				
				7.9. Оператор осуществляет
				...
				8. Перечень действий, производимых
				Оператором с полученными персональными данными 
				...
				орган по защите прав субъектов персональных данных о своем
				намерении осуществлять трансграничную передачу персональных
				...
				10. Конфиденциальность персональных данных Оператор и
				...
				адресу <a href="https://polotnotex.ru/privacy/">https://polotnotex.ru/privacy/</a>.
			</div>
		</>
	);
}
