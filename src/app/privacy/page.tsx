...
export default function Privacy() {
	return (
		<>
			<SiteHeader />
			<div className={`${styles.privacyPolicy} ${roboto.className}`}>
				<h4 className={styles.mainTitle}>
					Политика в отношении обработки персональных данных
				</h4>
				<br />
				<h5 className={styles.point_title}>1. Общие положения</h5>
				<br />
				<p className={styles.text}>
					...
					персональных данных. Предпринимает их Текстильное
					Полотно (далее — Оператор).
				</p>
				<br />
				<p className={styles.text}>
				...
				<p className={styles.text}>
					...
					сайта 
					<a href="https://polotnotex.ru/">https://polotnotex.ru/</a>.
				</p>
				<br />
				<h5 className={styles.point_title}>
				...
				<br />
				<p className={styles.text}>
					2.3. Сайт — совокупность графических и информационных
				...
				<p className={styles.text}>
					...
					персональных данных согласия на обработку персональных
					данных, а также, направления обращения с требованием о
					...
					определять состав и перечень мер, необходимых и достаточных
				...
				<p className={styles.text}>
					...
					данных; — прекратить передачу (распространение,
				...
				<p className={styles.text}>
					...
					Законом о персональных данных; — требовать от оператора
				...
				<br />
				<p className={styles.text}>
					5.8. Не происходит передачи персональных данных при
					получении пользователем промокодов, купонов или иных акций и
					скидок на сторонних ресурсах.
				</p>
				<br />
				<h5 className={styles.point_title}>
				...
				<br />
				<p className={styles.text}>
					6.2. Обработка персональных данных необходима для достижения
				...
				<br />
				<p className={styles.text}>
					6.3. Обработка персональных данных необходима для
				...
				<br />
				<p className={styles.text}>
					6.4. Обработка персональных данных необходима для исполнения
				...
				<br />
				<p className={styles.text}>
					6.5. Обработка персональных данных необходима для
				...
				<br />
				<h5 className={styles.point_title}>
					7. Порядок сбора, хранения, передачи и других видов
					обработки персональных данных Безопасность персональных
					данных, которые обрабатываются Оператором, обеспечивается
					путем реализации правовых, организационных и технических
				...
				<br />
				<p className={styles.text}>
					7.1. Оператор обеспечивает сохранность персональных данных и
					принимает все возможные меры, исключающие доступ к
					персональным данным неуполномоченных лиц.
				</p>
				<br />
				<p className={styles.text}>
					7.2. Персональные данные Пользователя никогда, ни при каких
				...
				<p className={styles.text}>
					...
					Оператора 
					<a href="mailto:zakaz@polotnotex.ru">zakaz@polotnotex.ru</a>
					 с пометкой "Актуализация персональных данных".
				</p>
				<br />
				<p className={styles.text}>
					7.4. Срок обработки персональных данных определяется
				...
				<br />
				<p className={styles.text}>
					7.5. Вся информация, которая собирается сторонними
				...
				<br />
				<p className={styles.text}>
					7.6. Установленные субъектом персональных данных запреты на
				...
				<br />
				<p className={styles.text}>
					7.7. Оператор при обработке персональных данных обеспечивает
					конфиденциальность персональных данных.
				</p>
				<br />
				<p className={styles.text}>
					7.8. При осуществлении доставки товаров Оператор может
					собирать данные о конечной точке доставки и получателе,
					чтобы точно рассчитать маршрут. Грузоперевозка
					осуществляется с помощью транспортных компаний и курьерских
					служб доставки. Цены по тарифам перевозчика в зависимости от
					объёма и массы груза, а так же удалённости от точки
					отправки.
				</p>
				<br />
				<p className={styles.text}>
					7.9. Оператор осуществляет хранение персональных данных в
				...
				<br />
				<h5 className={styles.point_title}>
					8. Перечень действий, производимых Оператором с полученными
					персональными данными
				</h5>
				<br />
				<p className={styles.text}>
					8.1. Оператор осуществляет сбор, запись, систематизацию,
				...
				<br />
				<p className={styles.text}>
					8.2. Оператор осуществляет автоматизированную обработку
				...
				<br />
				<p className={styles.text}>
					9.1. Оператор до начала осуществления деятельности по
				...
				<br />
				<p className={styles.text}>
					9.2. Оператор до подачи вышеуказанного уведомления, обязан
				...
				<br />
				<h5 className={styles.point_title}>
					10. Конфиденциальность персональных данных Оператор и иные
				...
				<p className={styles.text}>
					...
					<a href="https://polotnotex.ru/privacy/">
						https://polotnotex.ru/privacy/
					</a>
					.
				</p>
			</div>
